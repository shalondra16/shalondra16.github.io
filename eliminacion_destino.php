...
$consulta="SELECT * FROM destino WHERE des_codigo='$cod'";
$resultado=mysqli_query($conec,$consulta);

       if ($resultado && mysqli_num_rows($resultado) > 0) {
            while ($fila = mysqli_fetch_assoc($resultado)) {
        echo "<div class='info'>"; 
        echo "<p>Destino codigo: " . $fila['des_codigo'] . "</p>";
        echo "<p>Continente: " . $fila['des_continente'] . "</p>";
        echo "<p>Pais: " . $fila['des_nombre'] . "</p>";
        echo "</div>";
    }
	...
	?>
        ...
        <div class="form-container">
            <form action="eliminar_datos_destino.php" method="POST">
                <h3>¿Desea eliminar el registro?</h3><br>
                <input type="hidden" name="cdestino" value="<?php echo $cod; ?>"> 

                <div class="button-container">
                    <input type="submit" name="ok" value="Eliminar">
                    <a href="destinos_consulta.php" class="back-button">Volver</a>
                </div>
            </form>
        </div> 
    </div>
